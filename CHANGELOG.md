...
- Renamed the `MoneytreeIsshoTsucho` framework to `MoneytreeLINKKit` to reflect the new product. The class `MTIsshoTsucho` has similarly been renamed to `MTLinkKit`.
