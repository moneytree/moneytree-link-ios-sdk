 ...
 */
@property (nonatomic, copy, readonly) MTLConfiguration *configuration;

@property (nonatomic, copy, readonly) NSString *sdkClientId;

@property (nonatomic, copy, readonly) NSString *redirectUrlForMTToken;

@property (nonatomic, copy, readonly) NSString *redirectUrlForAuth;
...
/**
 ...
 @param codeVerifier to configure url
 @param email the user's email to be pre-filled on the fast onboarding page
 @param region An extensible enum that represents the region of the authorization process
 @return An absolute url that can take the user to the fast onboarding flow
*/
