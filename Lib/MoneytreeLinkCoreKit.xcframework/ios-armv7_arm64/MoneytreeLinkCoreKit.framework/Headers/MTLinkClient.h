...
/**
 Present an instance of `SFSafariViewController` to open the fast onboarding authorize page pre-filled with
 the specified email address.

 @param viewController The view controller that is used to present the fast onboarding screen.
...
/**
  ...
  @param email The view controller that is used to present the fast onboarding screen
