...
/// - Single Sign On will fall back to OTP or Passwordless (preferring OTP), if they are configured; otherwise, it will fall back to Credentials.
/// - Passwordless and OTP will fall back to Credentials.
...
extern MTLAuthenticationMethod const MTLAuthenticationMethodOtp;
