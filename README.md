...
1. Follow the prompts and fill in the URL as `https://github.com/moneytree/moneytree-link-ios-sdk` with a minimum version of `6.0.0`.
    - If you want to use beta version, copy the full SHA of the tagged beta release commit, select `Rules: Commit` then paste in the copied SHA.
