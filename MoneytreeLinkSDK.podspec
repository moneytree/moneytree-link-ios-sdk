      ...
      Pod::Spec.new do |s|
        ...
        s.platform          = :ios
        s.source            = { :git => 'https://github.com/moneytree/moneytree-link-ios-sdk.git', :tag => 'v6.1.0-1605' }
        s.ios.deployment_target = '9.0'
        s.ios.vendored_frameworks = 'Lib/MoneytreeLINKKit.xcframework', 'Lib/MoneytreeKeychainUtils.xcframework', 'Lib/MoneytreeLinkCoreKit.xcframework'
      end
